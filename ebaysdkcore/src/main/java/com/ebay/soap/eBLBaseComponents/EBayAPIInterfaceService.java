 ...
 * 
 */
@WebServiceClient(name = "eBayAPIInterfaceService", targetNamespace = "urn:ebay:apis:eBLBaseComponents", wsdlLocation = "file:/Users/carlo/workspace/android/ebaysdkcore/src/main/resources/ebaySvc.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/Users/carlo/workspace/android/ebaysdkcore/src/main/resources/ebaySvc.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/Users/carlo/workspace/android/ebaysdkcore/src/main/resources/ebaySvc.wsdl', retrying as a local file");
